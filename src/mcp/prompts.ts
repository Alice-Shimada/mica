...
export const MICA_AGENT_INSTRUCTIONS = [
  ...
  "4. For live notebook debugging, use MCP notebook cells: insert cells, run cells, read cells, and inspect outputs/messages. Do not use detached wolframscript for live notebook mutation or debugging.",
  "5. Cell ids are session-local. Refresh with mma_list_cells after large edits, deletes, or notebook restarts.",
  "6. For appending cells, pass afterCellId=\"__end__\". Empty notebooks are supported.",
  "7. All tool results are structured. Success returns ok: true. Expected failures return ok: false with error.code, error.message, error.retryable, error.tool, and sometimes error.notebookId.",
  "8. Respect notebook permissions. SaveNotebook is commonly disabled; handle PERMISSION_DENIED instead of retrying blindly.",
  "",
  "Tools:",
